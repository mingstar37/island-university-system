...
if (isset($_POST['load_data'])) {
    ...
    if(!empty($search_text)) {
        $sqlFaculty .= " WHERE name LIKE '%$search_text%' OR dept_first_name LIKE '%$search_text%'";
        $sqlFaculty .= " OR dept_last_name LIKE '%$search_text%' OR building_name LIKE '%$search_text%'";
        $sqlFaculty .= " OR chair_room_no LIKE '%$search_text%' OR id LIKE '%$search_text%'";
    }
    ...
    <div class="main-page">
        ...
        <table class="table table-bordered">
            ...
            <tr>
                ...
                <th>Department Chair First Name</th>
...
<script src="../js/administrator/departments.js"></script>
</body>
</html>
