...
if (isset($_POST['load_data'])) {
    ...
    if (!empty($student_id)) {
        $sqlAdvisees .= " AND a.student_id = '$student_id'";
    }
...
//    get prereq course
    ...
    $sql = "SELECT s.id, concat(u.first_name, ' ', u.last_name) student_name";
        ...
        <div class="row table-toolbar">
            ...
            <div class="col-lg-3">
                <div class="form-group px-1">
                    Student: &nbsp;
                    <select class="student-selectpicker" id="student_id" name="student_id" data-live-search="true">
                    </select>
                </div>
            </div>
...
<script src="../js/administrator/student-advisors.js"></script>
