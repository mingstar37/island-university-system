...
<div class="container">
        ...
        <div class="main-section">
            ...
            <div class="site-heading">
                <h2>Island University</h2>
            </div>
            <hr>
            <h3>Degree Programs </h3> <br>
            <h4>Majors </h4> <br>
            <ul>
            <li>Biological Sciences, B.S.</li>
            <li>Chemistry, B.S.</li>
            <li>Mathematics, B.S.</li>
            <li>Computer Information Sciences, B.S.</li>
            <li>Visual Arts: Electronic Media, B.S.</li>
            <li>Health and Society, B.S.</li>
