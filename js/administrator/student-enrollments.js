        ...
        success: function (res) {
            if (res != undefined) {
                ...
                crn_arr.forEach(item => {
                    sectionHtml += "<option value='" + item.id + "'>" + item.course_name + "</option>"
                });
    ...
    $.ajax({
        ...
        success: function (res) {
            if (res != undefined) {
                ...
                let studentHtml = '<select id="student_id" name="student_id" class="student-selectpicker" onchange="onSelectStudentPicker(event)" data-live-search="true"><option value="0">All</option>';
    ...
    $.ajax({
        ...
        success: function (res) {
            if (res != undefined) {
                ...
                $('.section-selectpicker').selectpicker('val', section_id);
