...
function onLoadData(bLoadMain = true) {
    ...
    request.first_minor = $('#first_minor').prop('checked') ? $('#first_minor').val(): "";
    request.second_minor = $('#second_minor').prop('checked') ? $('#second_minor').val(): "";
    ...
    $.ajax({
        ...
        success: function (res) {
            if (res !== undefined) {
                ...
                $('#minor-table-body').html(res.minorHtml);
            }
        },
        complete: function () {
        }
...
function onAddToStudentMinor(minor_id) {

    let request = {};
    request.minor_id = minor_id;
    request.student_id = $('#student_id').val();
    request.first_minor = $('#first_minor').prop('checked') ? $('#first_minor').val(): "";
    request.second_minor = $('#second_minor').prop('checked') ? $('#second_minor').val(): "";
    request.add_minor = true;
