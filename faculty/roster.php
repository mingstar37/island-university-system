...
// echo 'this user faculty id  = ' . $userId;
// exit;
...
<div id="header">
    ...
    <div id="main-section">
        ...
        <h2 style="margin-left:50px;"> Roster </h2>
        <br>
...
//                    $sqlDay = "SELECT * FROM `time_slot_day` WHERE `Time_Slot_ID` = " . $timeSlotId . " AND `Week_Day` = '" . $curDay . "'";
//                    $queryDay = mysqli_query($conn,$sqlDay);
//                    if(mysqli_num_rows($queryDay) > 0){
//                        echo '<td><a href="viewRosterCourse.php?crn='.$sections[$i]["CRN_Num"].'&cname='.$result["Course_Name"].'">View</a></td>';
//                    } else {
//                        echo '<td></td>';
//                    }
                    echo '<td><a href="viewRosterCourse.php?crn='.$sections[$i]["CRN_Num"].'&cname='.$result["Course_Name"].'">View</a></td>';
